    ...
    <>
      ...
      <div className="h-full pt-16 px-4 flex flex-col justify-between items-center bg-[#FFF8E7]">
        ...
        <div className="relative w-full">
          <div className="absolute left-2 -top-14 w-[152px] py-3 px-4 bg-[#FDD931] rounded-lg text-xs">
            What are all these tickets trying to say?
          </div>
          <div className="absolute left-8 -bottom-10 w-[152px] py-3 px-4 bg-[#FDD931] rounded-lg text-xs">
            How did they survive all these centuries?
          </div>
          <div className="absolute -right-2 top-28 w-[150px] py-3 px-4 bg-[#FDD931] rounded-lg text-xs">
            Take a small pause to reflect..
          </div>
          <div className="absolute -right-2 -bottom-28 w-[150px] py-3 px-4 bg-[#FDD931] rounded-lg text-xs">
