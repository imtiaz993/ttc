            ...
            <div className="fixed inset-0 z-50 flex items-end justify-center bg-black bg-opacity-50">
              <div className="bg-white w-full rounded-t-2xl p-6 shadow-xl">
                ...
                <div className="grid grid-cols-3 gap-4 text-center text-sm font-medium">
                  <a
                      href={`https://wa.me/?text=${encodeURIComponent(userData.createdTika)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex flex-col items-center"
                  >
                    <img src="/icons/whatsapp.svg" alt="WhatsApp" className="w-8 mb-1" />
                    WhatsApp
                  </a>
                  <a
                      href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(userData.createdTika)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex flex-col items-center"
                  >
                    <img src="/icons/facebook.svg" alt="Facebook" className="w-8 mb-1" />
                    Facebook
                  </a>
                  <a
                      href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(userData.createdTika)}&text=Check+out+this+Tika!`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex flex-col items-center"
                  >
                    <img src="/icons/twitter.svg" alt="Twitter" className="w-8 mb-1" />
                    Twitter
                  </a>
                  <a
                      href={`https://t.me/share/url?url=${encodeURIComponent(userData.createdTika)}&text=Check+out+this+Tika!`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex flex-col items-center"
                  >
                    <img src="/icons/telegram.svg" alt="Telegram" className="w-8 mb-1" />
                    Telegram
                  </a>
                  <button
                      ...
                      className="flex flex-col items-center"
                  >
                    <img src="/icons/link.svg" alt="Copy Link" className="w-8 mb-1" />
                    Copy Link
                  </button>
                  <button
