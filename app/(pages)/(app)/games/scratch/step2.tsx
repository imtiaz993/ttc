...
const ScratchStep2 = () => {
    ...
    const renderActionButtons = () => {
        if (verificationStatus === "failure") {
            return (
                <div className="w-full flex gap-3 mt-auto mb-[80px]">
                    <button
            ...
            case "failure":
                return (
                    <div className="mt-10 mb-6 flex flex-col items-center w-[250px]">
                        ...
                        <p className="text-center mt-2">Have another go before these big cats disappear into the wild!</p>
                    </div>
                );
            default:
                return (
            ...
            <div className="h-full pt-16 px-4 flex flex-col justify-start items-center bg-[#FFF8E7]">
                ...
                {verificationStatus === "initial" && (
                    <div className="bg-[#FDD931] rounded py-3 px-4">
                        ...
                        <p className="mt-2 text-xs">Tap the camera to take a photo</p>
                    </div>
                )}
